...
- **Canonical Code IR**: Extracts semantic code symbols (classes, functions, methods, docstrings, calls, types) using Python `ast` (Tree-sitter integration planned for multi-language support).
...
# Generate living wiki documentation
